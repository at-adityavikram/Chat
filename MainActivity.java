...
addNotification("Aditya", "Aditya");
 Toast.makeText(MainActivity.this, getCurrent(), Toast.LENGTH_LONG).show();               
...
Toast.makeText(MainActivity.this, Integer.toString(giveId(sender)), Toast.LENGTH_LONG).show(); 
